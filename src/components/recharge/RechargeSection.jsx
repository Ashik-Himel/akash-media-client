    ...
    <section className="mt-12 lg:mt-16">
      <div className="container">
        <div className='flex justify-between items-center gap-8 [&>*]:flex-1'>
          ...
          <form className='bg-bg-color dark:bg-gray-700 px-6 py-8 rounded-lg' onSubmit={handleSubmit}>
            ...
            <input className='input w-full mb-4 bg-white dark:text-black' type="text" name="username" id="username" placeholder='Enter your username' required />

            <label htmlFor="amount" className='block font-medium mb-2'>Amount</label>
            <input className='input w-full mb-4 bg-white dark:text-black' type="number" name="amount" id="amount" placeholder='Enter recharge amount' required />
