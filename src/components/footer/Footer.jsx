  ...
  return (
    <footer className='bg-primary bg-opacity-10 mt-10'>
        ...
        <div className='py-10 grid grid-cols-[auto] sm:grid-cols-[auto_auto] lg:grid-cols-[auto_auto_auto] gap-8 justify-between items-center'>
          <div className='sm:col-span-2 lg:col-span-1'>
            ...
            <div className='flex items-center gap-6'>
              ...
              <a href="https://wa.me/+8801796775774" target="_blank" rel="noopener noreferrer">
          ...
          <div>
            <h4 className='text-2xl font-semibold text-primary mb-3'>Quick Links</h4>
          ...
          <div>
            <h4 className='text-2xl font-semibold text-primary mb-3'>Contact Us</h4>
            <div className='flex flex-col items-start gap-2 font-medium'>
              <a href="https://wa.me/+8801796775774" target="_blank" rel="noopener noreferrer">WhatsApp</a>
              <a href="https://www.messenger.com/" target="_blank" rel="noopener noreferrer">Messenger</a>
      ...
      <div className="bg-primary text-white py-5 text-center">
        <div className="container">
          <p>Copyright&copy;{new Date().getFullYear()} - Akash Media. All rights reserved by <a className='font-semibold' href="https://www.mediamax.com.bd" target="_blank" rel="noopener noreferrer">Media Group</a>.</p>
        </div>
      </div>
    </footer>
  );
